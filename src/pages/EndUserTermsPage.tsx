      ...
      <LegalPageContainer>
        ...
        <LegalContent>
          <LegalSection>
            ...
            <LegalParagraph>
              We serve only SMS clients. These End-User Terms of Service ("End-User Terms") govern your use of services provided by 
              {process.env.REACT_APP_COMPANY_NAME} when you make a purchase through our SMS offers.
            </LegalParagraph>
            <LegalParagraph>
          ...
          <LegalSection>
            ...
            <LegalParagraph>
              {process.env.REACT_APP_COMPANY_NAME} provides customer payment assistance services for SMS purchases. 
              Our services include:
            </LegalParagraph>
            <LegalList>
              <LegalListItem>
                <strong>Payment Processing:</strong> Secure processing of payments for products ordered through SMS
              </LegalListItem>
              <LegalListItem>
              ...
              <LegalListItem>
                <strong>Customer Service:</strong> Support for questions about your SMS order
              </LegalListItem>
              <LegalListItem>
            ...
            <LegalParagraph style={{ marginTop: '1rem' }}>
              We process payments for products you ordered via SMS. The products and services are provided 
